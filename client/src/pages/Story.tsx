      ...
      >
        ...
        >
          ...
          <motion.div
            ...
            transition={{ duration: 0.4 }}
            className="relative bg-white p-2 sm:p-3 rounded-2xl sm:rounded-3xl shadow-xl border-2 border-white overflow-hidden aspect-[5/5] will-change-transform"
          >
            {item.imageUrl ? (
              <motion.img
                src={item.imageUrl}
  ...
  const sortedStory = [
    {
      id: 1,
      title: "Pehli Nazar",
      content: "Jab pehli baar meri aakhon ne aapka cutu sa mukhda dekha tha, and maine meri chotu si aakhon se dekha ki meri shamo asliyat mei aur bhi zyada khoobsurat hai <3",
      imageUrl: "picture7.JPG",
      order: 1
    },
    {
      id: 2,
      title: "Growing Closer",
      content: "jab i got to know just how beautiful you are from the inside out, with every shared dance, especially smash banana :), hug, eye contact, every shared kissi, meal, lamha & humara judging sesh xD.",
      imageUrl: "picture8.jpg",
      order: 2
    },
    {
      id: 3,
      title: "Present Day",
      content: "aaj despite of all the ups and downs, and the worst days of our relationship, here we are meri jaan, as strong as always, and i just want you to know that, chahe kitna bhi jhagad lu tumse, i'm the happiest when i'm with you baby, thank you for giving me that. ",
      imageUrl: "picture10.png",
      order: 3
    },
  ];
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <header ref={headerRef} className="text-center py-12 sm:py-16 md:py-24 px-4 relative">
          ...
          >
            ...
            >
              tumhare saath mera har ek lamha mujhe mukkamal kar deta hai shamo 
            </motion.p>
          </motion.div>
        ...
        >
          ...
          <div className="relative z-10 space-y-6 sm:space-y-8 text-center">
            ...
            >
              But wait, humari kahani itnu si thodi hai 🤭
            </motion.p>
            ...
            >
              I hope you love each and every picture meri jaan ❤️
            </motion.p>
          </div>
        </motion.div>
      </div>
