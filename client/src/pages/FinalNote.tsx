...
const LoadingScreen = memo(() => (
  <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-rose-50 via-pink-50 to-purple-50">
    ...
    >
      Kuch special, sirf meri shamo ke liye...
    </motion.p>
  </div>
));
...
export default function FinalNote() {
  ...
  const fullText = "Mai janta hu ki i'm far from perfect but I just wanted to thank you for loving me so much ki mai bhul jata hu, thank you meri jaan for helping me with my darkness, for always staying by my side, for humesha supporting me, cheering for me so loud ki mai apni sari insecurities bhul gaya :) thank you mujhse pyaar krne ke liye, thank you mujhe sikhane ke liye ki pyaar hota kya hai aur pyaar karte kaise hai, mai aaj jo bhi hu sirf tumhare hone se hu, thank you shamo, for making me want to become the best version of myself, thank you mujhe itni saari memories dene ke liye woh bhi itni pyaari pyaari, I never thought I would ever feel the feeling of love but thank you so so sooo much for proving me wrong kuchu, I just want you to know that there's nothing in my life as precious as you, as important as you, and as home-like as you, mai tumhare saath meri zindagi bitana chahta hu shamo, ek chota sa ghar banana chahta hu shamo aur humare baccho ke liye ek accha papa banna chahta hu shamo toh please dont ever give up on me, and lastly im sorry for everything shamo, im sorry";
      ...
      <div className="w-full max-w-3xl relative z-10">
            ...
            >
              ...
              >
                ...
                <span className="font-serif text-xs sm:text-sm text-gray-500 italic">
                  Valentine's {new Date().getFullYear()}
                </span>
              </motion.div>
            </motion.div>
        ...
        >
          ...
          <p className="text-xs sm:text-sm text-gray-500 italic">
            I hope aapko accha laga ye surprise 🥰
          </p>
        </motion.div>
      </div>
    </div>
