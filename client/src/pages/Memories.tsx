...
const LoadingSpinner = memo(() => (
  <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-rose-50 via-pink-50 to-purple-50">
    ...
    >
      Loading humari precious moments...
    </motion.p>
  </div>
));
  ...
  const displayMemories = (memories && memories.length > 0) ? memories : [
    {
      ...
      url: "/picture1.png",
      type: "image",
      caption: "Humari pehli (official) date :)",
    ...
    },
    {
      ...
      url: "/picture2.png",
      type: "image",
      caption: "maar daalenge tumko xD",
      date: "16th June 2025",
      rotation: 3
    },
    {
      ...
      url: "/picture3.jpg",
      type: "image",
      caption: "first day in a live-in 🤭",
      date: "17th June 2025",
      rotation: -4
    },
    {
    ...
    },
    {
      ...
      url: "/picture5.png",
      type: "image",
      caption: "humara pehla rain dance ❤️",
      date: "19th June 2025",
      rotation: 5
    },
    {
      ...
      url: "/picture6.png",
      type: "image",
      caption: "tumhari pyaari si smile <3",
      date: "20th June 2025",
      rotation: -3
    }
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
        ...
        >
          ...
          >
            ...
            >
              woh har ek pal jinke liye mai jeeta hu ❤️
            </motion.p>
          </motion.div>
        ...
        >
          ...
          <div className="relative z-10 space-y-6 sm:space-y-8 text-center">
            ...
            >
              ye toh bas shuruwat hai meri jaan ❤️
            </motion.p>
          </div>
        </motion.div>
      </div>
