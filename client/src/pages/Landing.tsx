    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Aaj kuch kuch express karna chahta hu…
          </motion.span>
          ...
          >
            <p className="text-sm sm:text-base md:text-lg text-rose-700/80 font-light italic leading-relaxed px-4">
              Jabse aap meri life mei ho,
              <br />
              <span className="text-pink-600/90">ye duniya, meri duniya bohot acchi lagne lagi hai jaan.</span>
            </p>
          </motion.div>
        </motion.div>
        ...
        >
          ...
          >
            Click the heart whenever you're ready meri jaan ❤️
          </motion.p>
